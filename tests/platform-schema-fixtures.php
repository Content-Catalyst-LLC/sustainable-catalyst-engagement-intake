...
$checks=array(
 'v1.1.0 stable markers'=>strpos($main,'Plugin Name: Sustainable Catalyst Contact and Engagement Platform')!==false&&strpos($main,'Version:     1.3.0')!==false&&strpos($main,"SC_EI_DB_VERSION', '1.3.0'")!==false&&strpos($main,"SC_EI_PLATFORM_SCHEMA_VERSION', '1.3.0'")!==false,
