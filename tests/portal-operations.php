...
$checks = array(
	'v0.12.0 plugin and DB markers' => strpos( $main, 'Version:     0.12.0' ) !== false
...
echo "Engagement Intake v0.12.0 portal authentication and recovery operation checks passed.\n";
