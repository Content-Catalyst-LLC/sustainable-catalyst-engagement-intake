...
$checks = array(
	'v1.1.1 plugin and database markers' => strpos( $main, 'Version:     1.2.0' ) !== false
		&& strpos( $main, "SC_EI_DB_VERSION', '1.2.0'" ) !== false,
	'portal schema 1.4.0' => strpos( $main, "SC_EI_PORTAL_SCHEMA_VERSION', '1.4.0'" ) !== false,
