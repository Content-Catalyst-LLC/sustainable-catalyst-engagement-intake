...
$checks = array(
	'v0.11.0 plugin and DB markers' => strpos( $main, 'Version:     0.11.0' ) !== false
...
echo "Engagement Intake v0.11.0 portal authentication and recovery operation checks passed.\n";
