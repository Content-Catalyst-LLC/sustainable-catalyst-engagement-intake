...
$checks = array(
    'v1.1.1 identity with unchanged database schema' => false !== strpos( $main, 'Version:     1.6.0' )
        && false !== strpos( $main, "SC_EI_VERSION', '1.6.0'" )
        && false !== strpos( $main, "SC_EI_DB_VERSION', '1.6.0'" )
        && false !== strpos( $main, "SC_EI_PLATFORM_SCHEMA_VERSION', '1.6.0'" ),
    ...
    'WordPress stable tag updated' => false !== strpos( $readme, 'Stable tag: 1.6.0' ),
);
