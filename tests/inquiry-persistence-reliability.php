...
$checks = array(
    'v1.1.1 identity with unchanged database schema' => false !== strpos( $main, 'Version:     1.1.1' )
        && false !== strpos( $main, "SC_EI_VERSION', '1.1.1'" )
        && false !== strpos( $main, "SC_EI_DB_VERSION', '1.1.0'" )
    ...
    'live validation includes inquiry write-path columns' => false !== strpos( $validation, 'SC_EI_Database::inquiry_columns_exist()' )
        ...
        && false !== strpos( $validation, "'[TEST] v1.1.1 live validation'" ),
    ...
    'WordPress stable tag updated' => false !== strpos( $readme, 'Stable tag: 1.1.1' ),
);
