...
$checks = array(
    'v1.4.1 identity keeps database at 1.4.0' => false !== strpos( $main, 'Version:     2.0.0' ) && false !== strpos( $main, "SC_EI_VERSION', '2.0.0'" ) && false !== strpos( $main, "SC_EI_DB_VERSION', '2.0.0'" ) && false !== strpos( $main, "SC_EI_PLATFORM_SCHEMA_VERSION', '2.0.0'" ) && false !== strpos( $main, "SC_EI_PROPOSAL_SCHEMA_VERSION', '1.0.1'" ),
    ...
    'stable tag advances to v1.4.1' => false !== strpos( $readme, 'Stable tag: 2.0.0' ),
);
