...
$checks = array(
    'v1.4.1 identity keeps database at 1.4.0' => false !== strpos( $main, 'Version:     1.5.0' ) && false !== strpos( $main, "SC_EI_VERSION', '1.5.0'" ) && false !== strpos( $main, "SC_EI_DB_VERSION', '1.5.0'" ) && false !== strpos( $main, "SC_EI_PLATFORM_SCHEMA_VERSION', '1.5.0'" ) && false !== strpos( $main, "SC_EI_PROPOSAL_SCHEMA_VERSION', '1.0.1'" ),
    ...
    'live validation tests replay and immutable receipt integrity' => false !== strpos( $validation, "'[TEST] v1.5.0 live validation'" ) && false !== strpos( $validation, '$sender_sow_replay' ) && false !== strpos( $validation, '$accepted_replay' ) && false !== strpos( $validation, '$conversion_replay' ) && false !== strpos( $validation, 'verify_approval_integrity' ),
    ...
    'stable tag advances to v1.4.1' => false !== strpos( $readme, 'Stable tag: 1.5.0' ),
);
