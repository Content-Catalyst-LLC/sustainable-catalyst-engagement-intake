...
$checks = array(
    'v1.3.0 identity and schema versions' => false !== strpos( $main, 'Version:     1.6.0' ) && false !== strpos( $main, "SC_EI_DB_VERSION', '1.6.0'" ) && false !== strpos( $main, "SC_EI_CALENDAR_SCHEMA_VERSION', '1.0.1'" ) && false !== strpos( $main, "SC_EI_PLATFORM_SCHEMA_VERSION', '1.6.0'" ),
