...
$checks=array(
 ...
 'readme stable tag'=>strpos($readme,'Stable tag: 1.7.0')!==false,
 'no schema reset'=>strpos($main,"SC_EI_PORTAL_SCHEMA_VERSION', '1.8.0'")!==false&&strpos($main,"SC_EI_WORKFLOW_SCHEMA_VERSION', '1.3.0'")!==false&&strpos($main,"SC_EI_WORKFLOW_CORE_SCHEMA_VERSION', '1.0.0'")!==false,
