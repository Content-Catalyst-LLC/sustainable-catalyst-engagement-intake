...
$checks = array(
	'v0.12.0 markers' => false !== strpos( $main, 'Version:     0.12.0' )
		&& false !== strpos( $main, "SC_EI_DB_VERSION', '0.12.0'" )
...
echo "Engagement Intake v0.12.0 Workflow Core schema fixtures passed.\n";
