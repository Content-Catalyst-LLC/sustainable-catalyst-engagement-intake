...
$checks = array(
	...
	'live validation exercises governed lifecycle and cleanup' => false !== strpos( $validation, 'SC_EI_Lifecycle_Repository::transition' ) && false !== strpos( $validation, 'SC_EI_Lifecycle_Repository::sender_snapshot' ) && false !== strpos( $validation, "table( 'lifecycle_events' )" ) && false !== strpos( $validation, "sc-contact-engagement-live-validation/1.4" ),
