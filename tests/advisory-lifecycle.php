...
$checks = array(
	'v1.1.0 plugin and schema identity' => false !== strpos( $main, 'Version:     1.1.1' ) && false !== strpos( $main, "SC_EI_DB_VERSION', '1.1.0'" ) && false !== strpos( $main, "SC_EI_LIFECYCLE_SCHEMA_VERSION', '1.0.0'" ),
	...
	'live validation exercises governed lifecycle and cleanup' => false !== strpos( $validation, 'SC_EI_Lifecycle_Repository::transition' ) && false !== strpos( $validation, 'SC_EI_Lifecycle_Repository::sender_snapshot' ) && false !== strpos( $validation, "table( 'lifecycle_events' )" ) && false !== strpos( $validation, "sc-contact-engagement-live-validation/1.3" ),
