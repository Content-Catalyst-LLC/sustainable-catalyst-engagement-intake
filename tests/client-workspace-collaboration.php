...
$checks = array(
    'v1.5.0 plugin database platform portal and workspace identities' => false !== strpos( $main, 'Version:     1.6.0' ) && false !== strpos( $main, "SC_EI_DB_VERSION', '1.6.0'" ) && false !== strpos( $main, "SC_EI_PLATFORM_SCHEMA_VERSION', '1.6.0'" ) && false !== strpos( $main, "SC_EI_PORTAL_SCHEMA_VERSION', '1.7.0'" ) && false !== strpos( $main, "SC_EI_WORKSPACE_SCHEMA_VERSION', '1.0.0'" ),
