...
$checks = array(
	'v1.1.1 release markers' => strpos( $main, 'Version:     1.3.0' ) !== false
		&& strpos( $main, "SC_EI_DB_VERSION', '1.3.0'" ) !== false
		&& strpos( $main, "SC_EI_PORTAL_SCHEMA_VERSION', '1.5.0'" ) !== false
		&& strpos( $main, "SC_EI_ENGAGEMENT_SCHEMA_VERSION', '1.1.0'" ) !== false,
