...
$checks = array(
    'patch identity with unchanged database schema' => false !== strpos( $main, 'Version:     1.7.0' ) && false !== strpos( $main, "SC_EI_VERSION', '1.7.0'" ) && false !== strpos( $main, "SC_EI_DB_VERSION', '1.7.0'" ) && false !== strpos( $main, "SC_EI_SUPPORT_SCHEMA_VERSION', '1.0.1'" ),
