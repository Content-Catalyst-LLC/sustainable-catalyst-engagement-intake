<?php
/**
 * Focused static safety assertions for v0.8.1 authentication and recovery.
 */
...
if (
	...
	fwrite( STDERR, "Legacy v0.8.1 session migration is missing.\n" );
	exit( 1 );
}
...
echo "Engagement Intake v0.8.1 focused authentication and recovery checks passed.\n";
