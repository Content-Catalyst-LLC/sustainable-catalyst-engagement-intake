<?php
/**
 * Static v0.9.1 schema, repository, and privacy mapping checks.
 */
...
foreach ( array( $inquiries, $attachments, $reviews, $fit_repository, $portal_repository, $workflow_repository, $graph_repository, $communications, $templates, $privacy_repository, $policy_repository ) as $source ) {
...
echo "Engagement Intake v0.9.1 schema checks passed.\n";
