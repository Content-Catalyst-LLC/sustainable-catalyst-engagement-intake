...
$checks = array(
    'v1.6.0 release identity' => false !== strpos( $main, 'Version:     1.6.0' ) && false !== strpos( $main, "SC_EI_DB_VERSION', '1.6.0'" ) && false !== strpos( $main, "SC_EI_PLATFORM_SCHEMA_VERSION', '1.6.0'" ) && false !== strpos( $main, "SC_EI_ANALYTICS_SCHEMA_VERSION', '1.1.0'" ) && false !== strpos( $main, "SC_EI_SERVICE_INTELLIGENCE_SCHEMA_VERSION', '1.0.0'" ),
    ...
    'stable tag advances to v1.6.0' => false !== strpos( $readme, 'Stable tag: 1.6.0' ),
);
