...
$checks = array(
 'v1.3.1 identity with unchanged database schema' => strpos($main,'Version:     1.3.1')!==false && strpos($main,"SC_EI_VERSION', '1.3.1'")!==false && strpos($main,"SC_EI_DB_VERSION', '1.3.0'")!==false && strpos($main,"SC_EI_CALENDAR_SCHEMA_VERSION', '1.0.1'")!==false && strpos($main,"SC_EI_PLATFORM_SCHEMA_VERSION', '1.3.1'")!==false,
