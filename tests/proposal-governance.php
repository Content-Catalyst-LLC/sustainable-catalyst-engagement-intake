<?php
/** v1.4.0 proposal, Statement of Work, approval, and change-control contracts. */
...
$checks = array(
    'v1.4.0 plugin database platform and proposal identities' => false !== strpos( $main, 'Version:     1.4.0' ) && false !== strpos( $main, "SC_EI_DB_VERSION', '1.4.0'" ) && false !== strpos( $main, "SC_EI_PLATFORM_SCHEMA_VERSION', '1.4.0'" ) && false !== strpos( $main, "SC_EI_PROPOSAL_SCHEMA_VERSION', '1.0.0'" ),
    ...
    'nondestructive v1.4.0 migration is journaled' => false !== strpos( $repo, "MIGRATION_KEY = 'v1_4_0_proposals_statements_of_work_engagement_approvals'" ) && false !== strpos( $repo, "'no_destructive_migration' => true" ),
...
echo 'Sustainable Catalyst Contact and Engagement Platform v1.4.0 proposal governance checks passed (' . count( $checks ) . ' assertions).' . PHP_EOL;
