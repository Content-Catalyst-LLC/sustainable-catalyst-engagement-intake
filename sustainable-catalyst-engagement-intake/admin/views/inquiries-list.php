...
<div class="wrap sc-ei-admin">
	...
	<p class="description">
		<?php esc_html_e( 'Private inquiry records are visible only to users with Engagement Intake capabilities. Adaptive public forms are active in v0.2.0.', 'sustainable-catalyst-engagement-intake' ); ?>
	</p>

	<div class="sc-ei-admin__notice">
		<strong><?php esc_html_e( 'v0.2.0 adaptive contact hub active', 'sustainable-catalyst-engagement-intake' ); ?></strong>
