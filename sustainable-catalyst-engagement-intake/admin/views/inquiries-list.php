...
<div class="wrap sc-ei-admin">
	<h1 class="wp-heading-inline"><?php esc_html_e( 'Inquiries', 'sustainable-catalyst-engagement-intake' ); ?></h1>
	<p class="description">
	...
	<form method="get">
		<input type="hidden" name="page" value="sc-engagement-intake-inquiries">
		<?php
