...
<div class="wrap sc-ei-admin sc-ei-portal-admin">
	...
	<div class="sc-ei-portal-admin-boundary">
		...
		<span><?php esc_html_e( 'Raw invitation and session credentials are never stored. v0.12.0 retains atomic authentication, recovery, Teams, proposals, Graph synchronization, engagement visibility, incident-safe read-only access, durable abuse controls, and accessibility hardening while adding canonical Workflow Core synchronization.', 'sustainable-catalyst-engagement-intake' ); ?></span>
	</div>
