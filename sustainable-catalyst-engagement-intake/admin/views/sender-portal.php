...
<div class="wrap sc-ei-admin sc-ei-portal-admin">
	...
	<div class="sc-ei-portal-admin-boundary">
		...
		<span><?php esc_html_e( 'Raw invitation and session credentials are never stored. v0.9.0 retains atomic authentication and recovery while adding sender-safe Teams offers and proposals with human publication and contract boundaries.', 'sustainable-catalyst-engagement-intake' ); ?></span>
	</div>
