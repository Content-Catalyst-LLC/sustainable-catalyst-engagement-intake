...
$auto_repairs = array( 'refresh_version', 'repair_database', 'verify_migration', 'verify_patch_migration', 'verify_launch_migration', 'verify_lifecycle_migration', 'verify_support_migration', 'verify_support_reliability_patch', 'verify_calendar_migration', 'verify_calendar_reliability_patch', 'verify_proposal_governance_migration', 'verify_proposal_reliability_patch', 'verify_workspace_migration', 'repair_calendar_reliability', 'repair_storage', 'repair_crons' );
?>
			...
			<div class="sc-ei-platform-repair-list">
				<?php foreach ( $readiness['production_blockers'] as $check ) : ?>
					<article class="sc-ei-platform-repair-item sc-ei-platform-repair-item--<?php echo esc_attr( $check['status'] ); ?>">
						...
						<?php elseif ( 'review_proposals' === $check['repair'] ) : ?>
							<a class="button" href="<?php echo esc_url( admin_url( 'admin.php?page=sc-engagement-intake-proposals' ) ); ?>"><?php echo esc_html( $check['repair_label'] ); ?></a>
						<?php elseif ( 'review_client_workspaces' === $check['repair'] ) : ?>
							<a class="button" href="<?php echo esc_url( admin_url( 'admin.php?page=sc-engagement-intake-client-workspaces' ) ); ?>"><?php echo esc_html( $check['repair_label'] ); ?></a>
