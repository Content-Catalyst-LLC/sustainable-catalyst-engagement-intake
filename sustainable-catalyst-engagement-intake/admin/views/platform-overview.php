...
$errors = array(
	...
	'platform_not_ready_for_production'         => __( 'Production requires 100% readiness, no warnings, a recent passing live validation, and current backup evidence.', 'sustainable-catalyst-engagement-intake' ),
...
$auto_repairs = array( 'refresh_version', 'repair_database', 'verify_migration', 'verify_patch_migration', 'repair_storage', 'repair_crons' );
?>
<div class="wrap sc-ei-admin sc-ei-platform-admin" id="sc-ei-primary-content">
	<header class="sc-ei-admin__header sc-ei-platform-admin__header">
		<div>
			...
			<p><?php esc_html_e( 'Production readiness, live validation, public intake, secure sender collaboration, human review, Teams scheduling, engagement handoff, analytics, reliability, privacy, and Workflow Core integration.', 'sustainable-catalyst-engagement-intake' ); ?></p>
		</div>
		<div class="sc-ei-platform-admin__release"><span>v1.0.2</span><strong><?php echo esc_html( SC_EI_Platform_Schema::label( SC_EI_Platform_Schema::launch_states(), $readiness['launch_state'] ) ); ?></strong></div>
	</header>
	...
	<div class="sc-ei-platform-layout">
		<main>
			...
			<section class="sc-ei-admin__card sc-ei-admin__card--wide">
				...
				<p><?php esc_html_e( 'Readiness now verifies that the configured URL resolves to a published local page containing a supported shortcode.', 'sustainable-catalyst-engagement-intake' ); ?></p>
