	...
	<div class="sc-ei-diagnostics-grid sc-ei-diagnostics-grid--production">
		...
		<section class="sc-ei-admin__card sc-ei-admin__card--wide">
			...
			<div class="sc-ei-diagnostic-metrics">
				...
				<div><strong><?php echo esc_html( number_format_i18n( $diagnostics['portal_metrics']['pending_recovery'] ) ); ?></strong><span><?php esc_html_e( 'pending recovery', 'sustainable-catalyst-engagement-intake' ); ?></span></div>
				<div><strong><?php echo esc_html( number_format_i18n( $diagnostics['portal_metrics']['activation_rollbacks_today'] ) ); ?></strong><span><?php esc_html_e( 'safe rollbacks today', 'sustainable-catalyst-engagement-intake' ); ?></span></div>
			...
			<ul class="sc-ei-checks">
				...
				<li><span class="<?php echo $diagnostics['portal_security']['cookie_httponly'] && 'Strict' === $diagnostics['portal_security']['cookie_samesite'] && '__Host-sc_ei_sender_session' === $diagnostics['portal_security']['cookie_name'] ? 'sc-ei-check--ok' : 'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e( '__Host HttpOnly SameSite Strict session cookie', 'sustainable-catalyst-engagement-intake' ); ?></li>
				<li><span class="<?php echo $diagnostics['portal_security']['atomic_activation'] && ! $diagnostics['portal_security']['wrong_token_lockout'] ? 'sc-ei-check--ok' : 'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e( 'atomic activation and wrong-token lockout protection', 'sustainable-catalyst-engagement-intake' ); ?></li>
				<li><span class="<?php echo $diagnostics['portal_security']['recovery_enabled'] && $diagnostics['portal_security']['recovery_human_review'] && ! $diagnostics['portal_security']['recovery_auto_issue'] && ! $diagnostics['portal_security']['recovery_auto_email'] ? 'sc-ei-check--ok' : 'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e( 'non-enumerating recovery requires human review', 'sustainable-catalyst-engagement-intake' ); ?></li>
			...
			<dl class="sc-ei-admin__details">
				...
				<dt><?php esc_html_e( 'Recovery requests today', 'sustainable-catalyst-engagement-intake' ); ?></dt><dd><?php echo esc_html( number_format_i18n( $diagnostics['portal_metrics']['recovery_today'] ) ); ?></dd>
				<dt><?php esc_html_e( 'Secure transport now', 'sustainable-catalyst-engagement-intake' ); ?></dt><dd><?php echo $diagnostics['portal_security']['secure_transport_now'] ? esc_html__( 'available', 'sustainable-catalyst-engagement-intake' ) : esc_html__( 'not detected', 'sustainable-catalyst-engagement-intake' ); ?></dd>
			</dl>
		...
		<section class="sc-ei-admin__card sc-ei-admin__card--wide">
			<p class="sc-ei-admin__card-kicker"><?php esc_html_e( 'Operational Handoff', 'sustainable-catalyst-engagement-intake' ); ?></p>
			<h2><?php esc_html_e( 'Proposal and Engagement Handoff Health', 'sustainable-catalyst-engagement-intake' ); ?></h2>
			<div class="sc-ei-diagnostic-metrics">
				<div><strong><?php echo esc_html( number_format_i18n( $diagnostics['engagement_metrics']['total'] ) ); ?></strong><span><?php esc_html_e( 'engagement records', 'sustainable-catalyst-engagement-intake' ); ?></span></div>
				<div><strong><?php echo esc_html( number_format_i18n( $diagnostics['engagement_metrics']['handoff_pending'] ) ); ?></strong><span><?php esc_html_e( 'handoff pending', 'sustainable-catalyst-engagement-intake' ); ?></span></div>
				<div><strong><?php echo esc_html( number_format_i18n( $diagnostics['engagement_metrics']['ready_for_setup'] ) ); ?></strong><span><?php esc_html_e( 'ready for setup', 'sustainable-catalyst-engagement-intake' ); ?></span></div>
				<div><strong><?php echo esc_html( number_format_i18n( $diagnostics['engagement_metrics']['active'] ) ); ?></strong><span><?php esc_html_e( 'active', 'sustainable-catalyst-engagement-intake' ); ?></span></div>
				<div><strong><?php echo esc_html( number_format_i18n( $diagnostics['engagement_metrics']['blocking_required'] ) ); ?></strong><span><?php esc_html_e( 'blocking required items', 'sustainable-catalyst-engagement-intake' ); ?></span></div>
				<div><strong><?php echo esc_html( $diagnostics['engagement_schema_version'] ); ?></strong><span><?php esc_html_e( 'engagement schema', 'sustainable-catalyst-engagement-intake' ); ?></span></div>
			</div>
			<ul class="sc-ei-checks">
				<li><span class="<?php echo $diagnostics['engagement_controls']['unique_proposal_handoff'] ? 'sc-ei-check--ok' : 'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e( 'one engagement per contracted proposal', 'sustainable-catalyst-engagement-intake' ); ?></li>
				<li><span class="<?php echo $diagnostics['engagement_controls']['immutable_snapshot'] && $diagnostics['engagement_controls']['snapshot_hash_required'] ? 'sc-ei-check--ok' : 'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e( 'immutable contracted-proposal snapshot with SHA-256 integrity', 'sustainable-catalyst-engagement-intake' ); ?></li>
				<li><span class="<?php echo $diagnostics['engagement_controls']['contract_reference_required'] && $diagnostics['engagement_controls']['owner_required'] && $diagnostics['engagement_controls']['all_required_items'] ? 'sc-ei-check--ok' : 'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e( 'contract reference, owner, and required onboarding checks gate readiness', 'sustainable-catalyst-engagement-intake' ); ?></li>
				<li><span class="<?php echo $diagnostics['engagement_controls']['human_ready_required'] && $diagnostics['engagement_controls']['human_activation_required'] ? 'sc-ei-check--ok' : 'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e( 'separate typed human readiness and activation decisions', 'sustainable-catalyst-engagement-intake' ); ?></li>
				<li><span class="<?php echo ! $diagnostics['engagement_controls']['automatic_activation'] && ! $diagnostics['engagement_controls']['automatic_provisioning'] && ! $diagnostics['engagement_controls']['automatic_invoice'] && ! $diagnostics['engagement_controls']['automatic_payment'] && ! $diagnostics['engagement_controls']['electronic_signature'] ? 'sc-ei-check--ok' : 'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e( 'no automatic activation, provisioning, invoice, payment, or electronic signature', 'sustainable-catalyst-engagement-intake' ); ?></li>
				<li><span class="<?php echo $diagnostics['engagement_controls']['portal_sender_safe'] ? 'sc-ei-check--ok' : 'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e( 'sender portal exposes only sender-safe engagement data', 'sustainable-catalyst-engagement-intake' ); ?></li>
			</ul>
			<dl class="sc-ei-admin__details">
				<dt><?php esc_html_e( 'Workbench handoff export', 'sustainable-catalyst-engagement-intake' ); ?></dt><dd><?php echo $diagnostics['engagement_controls']['workbench_export'] ? esc_html__( 'enabled without provisioning', 'sustainable-catalyst-engagement-intake' ) : esc_html__( 'disabled', 'sustainable-catalyst-engagement-intake' ); ?></dd>
				<dt><?php esc_html_e( 'Decision Studio handoff export', 'sustainable-catalyst-engagement-intake' ); ?></dt><dd><?php echo $diagnostics['engagement_controls']['decision_studio_export'] ? esc_html__( 'enabled without provisioning', 'sustainable-catalyst-engagement-intake' ) : esc_html__( 'disabled', 'sustainable-catalyst-engagement-intake' ); ?></dd>
			</dl>
...
\t\t\t<div class="sc-ei-diagnostic-metrics"><div><strong><?php echo esc_html(number_format_i18n($diagnostics['hardening']['metrics']['open_critical'])); ?></strong><span><?php esc_html_e('open critical','sustainable-catalyst-engagement-intake'); ?></span></div><div><strong><?php echo esc_html(number_format_i18n($diagnostics['hardening']['metrics']['open_warning'])); ?></strong><span><?php esc_html_e('open warnings','sustainable-catalyst-engagement-intake'); ?></span></div><div><strong><?php echo $diagnostics['hardening']['public_writes_paused']?esc_html__('Paused','sustainable-catalyst-engagement-intake'):esc_html__('Open','sustainable-catalyst-engagement-intake'); ?></strong><span><?php esc_html_e('public writes','sustainable-catalyst-engagement-intake'); ?></span></div><div><strong><?php echo esc_html($diagnostics['hardening_schema_version']); ?></strong><span><?php esc_html_e('hardening schema','sustainable-catalyst-engagement-intake'); ?></span></div></div>
\t\t\t<ul class="sc-ei-checks"><li><span class="<?php echo !in_array(false,$diagnostics['hardening_columns'],true)?'sc-ei-check--ok':'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e('health and durable rate-limit schema','sustainable-catalyst-engagement-intake'); ?></li><li><span class="<?php echo $diagnostics['hardening']['watchdog_scheduled']&&$diagnostics['hardening']['prune_scheduled']?'sc-ei-check--ok':'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e('watchdog and pruning schedules','sustainable-catalyst-engagement-intake'); ?></li><li><span class="<?php echo $diagnostics['hardening']['durable_rate_limits']&&$diagnostics['hardening']['health_event_deduping']?'sc-ei-check--ok':'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e('database-backed abuse limits and deduplicated health events','sustainable-catalyst-engagement-intake'); ?></li><li><span class="<?php echo $diagnostics['hardening']['security_headers']&&$diagnostics['hardening']['accessibility_helpers']?'sc-ei-check--ok':'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e('security headers and accessibility helpers','sustainable-catalyst-engagement-intake'); ?></li><li><span class="<?php echo $diagnostics['hardening']['no_secret_context']&&$diagnostics['hardening']['no_automatic_decisions']&&$diagnostics['hardening']['no_automatic_deletion']?'sc-ei-check--ok':'sc-ei-check--bad'; ?>">●</span> <?php esc_html_e('no secret context, automated decisions, or automated deletion','sustainable-catalyst-engagement-intake'); ?></li></ul>
\t\t\t<p><a class="button" href="<?php echo esc_url(admin_url('admin.php?page=sc-engagement-intake-reliability')); ?>"><?php esc_html_e('Open Reliability Workspace','sustainable-catalyst-engagement-intake'); ?></a></p>
\t\t</section>
		...
		<section class="sc-ei-admin__card">
			...
			<h3><?php esc_html_e( 'v1.0.1 inquiry, attachment, review, fit assessment, sender portal, Teams scheduling, Microsoft Graph reliability, proposal, engagement handoff, analytics, hardening, Workflow Core, communication, and privacy fields', 'sustainable-catalyst-engagement-intake' ); ?></h3>
			...
			<h3><?php esc_html_e( 'Proposal and engagement handoff tables and fields', 'sustainable-catalyst-engagement-intake' ); ?></h3>
			<ul class="sc-ei-checks sc-ei-checks--columns"><?php foreach ( $diagnostics['engagement_columns'] as $column => $ok ) : ?><li><span class="<?php echo $ok ? 'sc-ei-check--ok' : 'sc-ei-check--bad'; ?>">●</span> <?php echo esc_html( $column ); ?></li><?php endforeach; ?></ul>
