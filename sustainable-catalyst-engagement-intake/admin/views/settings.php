...
<div class="wrap sc-ei-admin">
	...
	<p><?php esc_html_e( 'v0.8.1 hardens Secure Sender Portal authentication and adds human-reviewed recovery while retaining Human-Controlled Fit Assessment alongside the centralized Privacy and Retention Center with versioned policies, consent evidence, privacy request cases, legal holds, queue-only retention scans, approval controls, verified execution, and tombstone preservation.', 'sustainable-catalyst-engagement-intake' ); ?></p>
	...
	<form method="post" action="options.php">
		...
		<section class="sc-ei-admin__card sc-ei-admin__settings-card">
			...
			<p><?php esc_html_e( 'These values seed and guide policy versions. Daily cron is permanently queue-only in v0.8.1; it cannot physically delete files or erase inquiry data.', 'sustainable-catalyst-engagement-intake' ); ?></p>
		...
		<section class="sc-ei-admin__card sc-ei-admin__settings-card">
			...
			<p><?php esc_html_e( 'Microsoft Teams is the only supported live meeting platform. v0.8.1 stores preferences and approved meeting records; Microsoft Graph event creation is not enabled yet.', 'sustainable-catalyst-engagement-intake' ); ?></p>
			<table class="form-table" role="presentation">
				<tr>
