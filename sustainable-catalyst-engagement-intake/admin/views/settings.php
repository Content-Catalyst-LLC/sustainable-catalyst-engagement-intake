...
<div class="wrap sc-ei-admin">
	...
	<form method="post" action="options.php">
		...
		<section class="sc-ei-admin__card sc-ei-admin__settings-card">
			...
			<p><?php esc_html_e( 'These values seed and guide policy versions. Daily cron is permanently queue-only in v0.9.0; it cannot physically delete files or erase inquiry data.', 'sustainable-catalyst-engagement-intake' ); ?></p>
		...
		<section class="sc-ei-admin__card sc-ei-admin__settings-card">
			...
			<p><?php esc_html_e( 'Microsoft Teams is the only supported live meeting platform. v0.9.0 adds human-approved Teams offers and final meeting records; Microsoft Graph event creation remains disabled.', 'sustainable-catalyst-engagement-intake' ); ?></p>
			<table class="form-table" role="presentation">
				<tr>
