...
<div class="wrap sc-ei-admin">
	...
	<p><?php esc_html_e( 'v0.9.1 adds an optional encrypted Microsoft Graph reliability connector while retaining human-approved Teams scheduling, versioned proposals, Secure Sender Portal authentication, recovery, Human-Controlled Fit Assessment, and the centralized Privacy and Retention Center with versioned policies, consent evidence, privacy request cases, legal holds, queue-only retention scans, approval controls, verified execution, and tombstone preservation.', 'sustainable-catalyst-engagement-intake' ); ?></p>
	...
	<form method="post" action="options.php">
		...
		<section class="sc-ei-admin__card sc-ei-admin__settings-card">
			...
			<p><?php esc_html_e( 'These values seed and guide policy versions. Daily cron is permanently queue-only in v0.9.1; it cannot physically delete files or erase inquiry data.', 'sustainable-catalyst-engagement-intake' ); ?></p>
		...
		<section class="sc-ei-admin__card sc-ei-admin__settings-card">
			...
			<p><?php esc_html_e( 'Microsoft Teams remains the only supported live meeting platform. v0.9.1 optionally creates calendar-backed Teams events through a separate human-triggered Microsoft Graph connector; manual Teams URL finalization remains available.', 'sustainable-catalyst-engagement-intake' ); ?></p>
			<table class="form-table" role="presentation">
				<tr>
