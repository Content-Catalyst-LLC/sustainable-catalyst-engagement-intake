...
<div class="wrap sc-ei-admin">
	<p><a class="button" href="<?php echo esc_url( admin_url( 'admin.php?page=sc-engagement-intake' ) ); ?>"><?php esc_html_e( 'Open Platform Overview', 'sustainable-catalyst-engagement-intake' ); ?></a></p>
	<h1><?php esc_html_e( 'Engagement Intake Settings', 'sustainable-catalyst-engagement-intake' ); ?></h1>
	<p><?php esc_html_e( 'v1.0.1 adds a canonical Workflow Core, idempotent human commands, signed cross-plugin handoffs, and durable internal-adapter delivery while retaining reliability monitoring, engagement handoff, analytics, Microsoft Graph, Teams scheduling, versioned proposals, the Secure Sender Portal, Human-Controlled Fit Assessment, and the Privacy and Retention Center.', 'sustainable-catalyst-engagement-intake' ); ?></p>
	...
	<form method="post" action="options.php">
		...
		<section class="sc-ei-admin__card sc-ei-admin__settings-card">
			...
			<p><?php esc_html_e( 'These values seed and guide policy versions. Daily cron is permanently queue-only in v1.0.1; it cannot physically delete files or erase inquiry data.', 'sustainable-catalyst-engagement-intake' ); ?></p>
		...
		<section class="sc-ei-admin__card sc-ei-admin__settings-card">
			...
			<p><?php esc_html_e( 'Microsoft Teams remains the only supported live meeting platform. v1.0.1 retains optional human-triggered Microsoft Graph calendar creation and manual Teams finalization; neither path activates an engagement automatically.', 'sustainable-catalyst-engagement-intake' ); ?></p>
			<table class="form-table" role="presentation">
				<tr>
