...
<div class="wrap sc-ei-admin">
	...
	<p><?php esc_html_e( 'v0.9.2 adds controlled proposal-to-engagement handoff, immutable commercial snapshots, onboarding readiness, and typed human activation while retaining the optional Microsoft Graph connector, Teams scheduling, versioned proposals, Secure Sender Portal, Human-Controlled Fit Assessment, and the Privacy and Retention Center.', 'sustainable-catalyst-engagement-intake' ); ?></p>
	...
	<form method="post" action="options.php">
		...
		<section class="sc-ei-admin__card sc-ei-admin__settings-card">
			...
			<p><?php esc_html_e( 'These values seed and guide policy versions. Daily cron is permanently queue-only in v0.9.2; it cannot physically delete files or erase inquiry data.', 'sustainable-catalyst-engagement-intake' ); ?></p>
		...
		<section class="sc-ei-admin__card sc-ei-admin__settings-card">
			...
			<p><?php esc_html_e( 'Microsoft Teams remains the only supported live meeting platform. v0.9.2 retains optional human-triggered Microsoft Graph calendar creation and manual Teams finalization; neither path activates an engagement automatically.', 'sustainable-catalyst-engagement-intake' ); ?></p>
			<table class="form-table" role="presentation">
				<tr>
