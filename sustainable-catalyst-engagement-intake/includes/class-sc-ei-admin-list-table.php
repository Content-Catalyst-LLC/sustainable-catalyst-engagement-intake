...
final class SC_EI_Admin_List_Table extends WP_List_Table {
	...
	public function get_columns(): array {
		return array(
			...
			'status'        => __( 'Status', 'sustainable-catalyst-engagement-intake' ),
			'assigned_user' => __( 'Assigned', 'sustainable-catalyst-engagement-intake' ),
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			...
			case 'assigned_user':
				...
				$user = get_user_by( 'id', absint( $item['assigned_user_id'] ) );
	...
	protected function extra_tablenav( $which ): void {
		...
		<div class="alignleft actions">
			...
			<select name="status" id="sc-ei-status-filter">
				<option value=""><?php esc_html_e( 'All statuses', 'sustainable-catalyst-engagement-intake' ); ?></option>
