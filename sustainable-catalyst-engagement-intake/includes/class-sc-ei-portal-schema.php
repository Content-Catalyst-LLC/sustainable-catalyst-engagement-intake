...
final class SC_EI_Portal_Schema {
	...
	public static function views(): array {
		return array(
			...
			'workspace'   => __( 'Client Workspace', 'sustainable-catalyst-engagement-intake' ),
			'billing'     => __( 'Invoices & Payments', 'sustainable-catalyst-engagement-intake' ),
	...
	public static function permissions(): array {
		return array(
			...
			'view_workspace'    => __( 'View secure client workspace', 'sustainable-catalyst-engagement-intake' ),
			'view_billing'      => __( 'View sender-safe invoices and external payment handoffs', 'sustainable-catalyst-engagement-intake' ),
			'respond_deliverables' => __( 'Accept deliverables or request changes', 'sustainable-catalyst-engagement-intake' ),
	...
	public static function event_types(): array {
		return array(
			...
			'workspace_deliverable_response_recorded' => __( 'Workspace Deliverable Response Recorded', 'sustainable-catalyst-engagement-intake' ),
			'billing_viewed'            => __( 'Billing Records Viewed', 'sustainable-catalyst-engagement-intake' ),
			'workspace_message_recorded' => __( 'Workspace Collaboration Message Recorded', 'sustainable-catalyst-engagement-intake' ),
