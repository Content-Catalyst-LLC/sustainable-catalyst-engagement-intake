...
final class SC_EI_Capabilities {
	...
	public const ALL = array(
		...
		'sc_intake_view_client_workspaces',
		'sc_intake_manage_client_workspaces',
		'sc_intake_manage_workspace_milestones',
		'sc_intake_manage_workspace_deliverables',
		'sc_intake_manage_workspace_documents',
		'sc_intake_export_client_workspaces',
		'sc_intake_manage_statements_of_work',
		'sc_intake_approve_statements_of_work',
		'sc_intake_manage_change_requests',
		'sc_intake_approve_change_requests',
		'sc_intake_export_proposal_governance',
