...
final class SC_EI_Workflow_Schema {
	...
	public static function event_types(): array {
		return array(
			...
			'graph_event_queued'           => __( 'Graph Event Queued', 'sustainable-catalyst-engagement-intake' ),
			'graph_event_synced'           => __( 'Graph Event Synchronized', 'sustainable-catalyst-engagement-intake' ),
			'graph_join_url_pending'       => __( 'Graph Teams Join URL Pending', 'sustainable-catalyst-engagement-intake' ),
			'graph_operation_retry_scheduled'=> __( 'Graph Retry Scheduled', 'sustainable-catalyst-engagement-intake' ),
			'graph_operation_failed'       => __( 'Graph Operation Failed', 'sustainable-catalyst-engagement-intake' ),
			'graph_event_deleted'          => __( 'Graph Event Deleted', 'sustainable-catalyst-engagement-intake' ),
			'graph_remote_canceled'        => __( 'Graph Event Canceled Remotely', 'sustainable-catalyst-engagement-intake' ),
